...
This is the Claude Code entry point. [AGENTS.md](AGENTS.md) is this
repository's canonical, tool-neutral instruction source — see
[`docs/ai-strategy.md`](docs/ai-strategy.md) for the rationale. This file
imports it directly below.
