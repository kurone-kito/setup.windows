...
Install-WingetApps Starship.Starship
...
### SCM
Install-WingetApps Cretezy.lazyjj
Install-WingetApps dandavison.delta
Install-WingetApps JesseDuffield.lazygit
Install-WingetApps jj-vcs.jj
Install-WingetApps max-sixty.worktrunk
Install-WingetApps Silk.Subversion
