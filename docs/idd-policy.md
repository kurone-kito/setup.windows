...
(copied verbatim from the pinned upstream commit's
`skills/idd-spec-audit/`; no bundle-internal maintenance-doc links
needed relinking, unlike the issue-authoring companion above).
